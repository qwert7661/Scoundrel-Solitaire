...
if True:
    ...
    intro_surf = pg.image.load('graphics/scoundrel_intro.png')
    lose_surf = pg.image.load('graphics/scoundrel_lose.png')
    win_surf = pg.image.load('graphics/scoundrel_win.png')
...
while True:
    ...
    if game.hp <= 0 or lose == True:
        lose = True
        lose_text = font.render(f'You cleared {len(game.discard) + len(game.killed)} cards, '
